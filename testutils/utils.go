...
func CreateMsgAuctionBid(txCfg client.TxConfig, bidder Account, bid sdk.Coins, nonce uint64, numberMsgs int) (*pobtypes.MsgAuctionBid, error) {
	bidMsg := &pobtypes.MsgAuctionBid{
		Bidder:       bidder.Address.String(),
		Bid:          bid,
