...
func (t Terminator) PrepareLane(ctx sdk.Context, proposal blockbuster.Proposal, maxTxBytes int64, next blockbuster.PrepareLanesHandler) blockbuster.Proposal {
	return proposal
}
