...
func (suite *KeeperTestSuite) TestValidateBidInfo() {
	var (
		...
		balance  = sdk.NewCoin("foo", math.NewInt(10000))
		bid      = sdk.NewCoin("foo", math.NewInt(1000))

		// Auction params
		maxBundleSize          uint32 = 10
		reserveFee                    = sdk.NewCoin("foo", math.NewInt(1000))
		minBidIncrement               = sdk.NewCoin("foo", math.NewInt(1000))
	...
	cases := []struct {
		...
		},
		{
			...
			func() {
				bid = sdk.NewCoin("foo", math.NewInt(1000))
				balance = sdk.NewCoin("foo", math.NewInt(100))
			},
			false,
		},
		{
		...
		},
		{
			...
			func() {
				...
				highestBid = sdk.NewCoin("foo", math.NewInt(500))
				bid = sdk.NewCoin("foo", math.NewInt(500))
			},
			false,
		},
		{
			...
			func() {
				highestBid = sdk.NewCoin("foo", math.NewInt(500))
				bid = sdk.NewCoin("foo", math.NewInt(1500))
			},
			true,
		},
		{
			...
			func() {
				highestBid = sdk.NewCoin("foo", math.NewInt(500))
				bid = sdk.NewCoin("foo2", math.NewInt(1500))
			},
			false,
		},
		{
			...
			func() {
				highestBid = sdk.NewCoin("foo", math.NewInt(500))
				bid = sdk.NewCoin("foo", math.NewInt(1500))
				minBidIncrement = sdk.NewCoin("foo2", math.NewInt(1000))
			},
			false,
		},
	}
